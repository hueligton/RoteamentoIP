...
public class IPv4 extends BasePacket {
    ...
    public IPacket deserialize(byte[] data, int offset, int length)
        ...
        if (!isFragment && IPv4.protocolClassMap.containsKey(this.protocol)) {
            ...
            try {
                ...
                throw new RuntimeException("Error parsing payload for pacote.IPv4 packet", e);
            }
        } else {
            payload = new Data();
        }
    ...
    /**
     * Accepts an pacote.IPv4 address of the form xxx.xxx.xxx.xxx, ie 192.168.0.1 and
    ...
    public static int toIPv4Address(String ipAddress) {
        if (ipAddress == null)
            throw new IllegalArgumentException("Specified pacote.IPv4 address must" +
        ...
        for (int i = 0; i < 4; ++i) {
            ...
            if (oct > 255 || oct < 0)
                throw new IllegalArgumentException("Octet values in specified" +
                        " pacote.IPv4 address must be 0 <= value <= 255");
            result |= oct << ((3 - i) * 8);
        }
        return result;
    }
    ...
    /**
     * Accepts an pacote.IPv4 address in a byte array and returns the corresponding
    ...
    /**
     * Accepts an pacote.IPv4 address and returns of string of the form xxx.xxx.xxx.xxx
     * ie 192.168.0.1
     *
     * @param ipAddress
     * @return
    ...
    /**
     * Accepts a collection of pacote.IPv4 addresses as integers and returns a single
    ...
    /**
     * Accepts an pacote.IPv4 address in the form of an integer and
     * returns the corresponding byte array.
